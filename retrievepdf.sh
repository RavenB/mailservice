...
$WGETCMD $URL1 -O "$OUTPUTFOLDER/$TMPFILENAME1" -o "$LOGFOLDER/log_$FILENAMETIME.log"
$WGETCMD $URL2 -O "$OUTPUTFOLDER/$TMPFILENAME2" -o "$LOGFOLDER/log_$FILENAMETIME.log"
$WGETCMD $URL3 -O "$OUTPUTFOLDER/$TMPFILENAME3" -o "$LOGFOLDER/log_$FILENAMETIME.log"
